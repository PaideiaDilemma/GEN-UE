...
%%
%%      Wenn du  Stromrichtungen ändern willst, dann musst du
%%      bei den to[short] nach dem i ein < oder > machen ;)
%%
      %controlled Us_1
      \draw (0,0) to[cvsource, v_=$U_{S1}$, color=blue]  (0,5);
      %Us_2
      \draw (10,5) to[V, v=$U_{s2}$, color=blue]         (5,5);
      %Is_3
      \draw (18,5) to[I, i=$I_{s3}$, color =red]        (18,10);
      %R_1
      \draw                                     (5,0)
      to[short, *-]                             (6,0)
      to[R, l=$R_1$]                            (9,0)
      to[short, i<=$I_{R1}$, color=red]         (10,0);
      %R_2
      \draw                                     (5,0) 
      to[short]                                 (5,1)
      to[R, l=$R_2$]                            (5,4)
      ...
      to[short, *-]                             (5,6)
      to[R, l=$R_3$]                            (5,9)
      to[short, i=$I_{R3}$, color=red]          (5,10)
      to[short, -*]                             (5,10);
      %R_4
      \draw                                     (0,5)
      to[short, *-]                             (1,5)
      to[R, l=$R_4$]                            (4,5)
      to[short, i=$I_{R4}$, color=red]          (5,5);
      %R_5
      \draw                                     (10,5)
      to[short, *-]                             (10,6)
      to[R, l=$R_5$]                            (10,9)
      to[short, i=$I_{R5}$, color=red]          (10,10)
      to[short, -*]                             (10,10);
      %R_6
      \draw                                     (15,5)
      to[short, *-]                             (15,6) 
      to[R, l=$R_6$]                            (15,9)
      to[short, i=$I_{R6}$, color=red]          (15,10)
      to[short, -*]                             (15,10);
      %connections
      ...
      \draw (0,0) to (0,0) node[ground]{};
      %nodes
      \node[above]              (n_1) at (5,10) {$n_1$};
      \node[above, xshift=3mm]  (n_3) at (5,5) {$n_2$};
      \node[above, xshift=3mm]  (n_4) at (10,5) {$n_3$};
      \node[below]              (ref) at (5,0) {ref};

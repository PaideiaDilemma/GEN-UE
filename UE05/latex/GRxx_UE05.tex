...
\clearpage
We calculate every current and volatge in the circuit.
\begin{align*}
...
We can see, that the relation of the phasors to themselves are the same as in figure 2, only the coordinate system
"changed".

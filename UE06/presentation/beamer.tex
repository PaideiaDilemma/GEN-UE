...
\frametitle{Fourier series, numerically  with matlab}
  ...
  \end{figure}
  Let td and td be the return of our fsig function, and we get:
  \begin{figure}
...
\frametitle{Plot, $n=5$}
\begin{figure}
  \includegraphics[scale=0.6]{../latex/Figures/fourier_n5.png} 
\end{figure}
\end{frame}
...
\begin{figure}
  \includegraphics[scale=0.6]{../latex/Figures/fourier_n250.png} 
\end{figure}
\end{frame}
...
\begin{itemize}
  \item Yes, for all points $t$, where $f(t)$ is continous.
  \item $\frac{f(t+) + f(t-)}{2}$ for points $t$, where there is a conditional jump.

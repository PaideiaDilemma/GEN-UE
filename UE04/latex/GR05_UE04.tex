...
\begin{equation*}
	i_L(t) = e^{-\delta t}[K_1\cos(\Omega_dt) + K_2\sin(\Omega_dt)]\\
\end{equation*}
...
\begin{equation*}
	i_L(t = 0) = i_{L0} = \frac{U_0}{R_{13}} + \left[50mA - \frac{U_0}{R_{13}} \right] \cdot e^{-\frac{2\tau_1}{\frac{L}{R_{13}}}} = 93.2mA\\
\end{equation*}
...
\begin{align*}
	u_C(t = 0) = 0\\
	u_C(t = 0) = u_{R_3}(t = 0) + u_L(t = 0) = 0\\
	i_{L0}R_3 + Li_L'(t = 0) = 0\\
	i_L'(t = 0) = -\frac{i_{L0}R_3}{L}
\end{align*}
